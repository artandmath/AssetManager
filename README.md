...
The AssetManager panel is a demonstration prototype. It would be a part of a larger suite of tools and frameworks that seek to address some of the technical pain points in VFX work.
> [!CAUTION]
