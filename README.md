...
The AssetManager panel is a demonstration prototype and would be a part of a larger suite of tools and frameworks that seek to address pain points in VFX work.
> [!CAUTION]
